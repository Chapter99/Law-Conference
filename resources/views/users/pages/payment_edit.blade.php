...
@section('title') แก้ไขการแจ้งชำระเงิน @parent @endsection
...
<section class="content">
  ...
  <div class="card">
    <div class="card-header bg-secondary">
      <h3 class="card-title">แก้ไขการแจ้งชำระเงิน</h3>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('users.payment_update') }}" role="form" id="containerForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                  <input type="date" class="form-control @error('tdate') is-invalid @enderror" id="tdate" name="tdate" value="{{ $payment->tdate }}">
                  @error('tdate')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group row">
                ...
                <input type="hidden" id="id" name="id" value="{{ $payment->id }}">
                    <button type="submit" name="Submit" class="btn btn-primary" onclick="showLoading();">ปรับปรุง</button>
                </div>
            </div>
        </form>
    </div>
