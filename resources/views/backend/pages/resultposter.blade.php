...
<section class="content">
  ...
  <div class="card">
    <div class="card-header bg-secondary">
      <h3 class="card-title">ผลการประเมิน Poster/Infograhic</h3>
    ...
    <div class="card-body">
        ...
        @endforeach
        <hr>
        <form method="POST" action="{{ route('backend.resultposter_save', $paper->id) }}" role="form" id="containerForm">
          @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-9">
                  @if($paper->paper_status == 1 and $paper->reviewer_poster()->where('result','!=', 0)->count() == $paper->reviewer_poster()->count() and $paper->reviewer_poster()->count() != 0)
                  <button type="submit" name="Submit" class="btn btn-success" onclick="showLoading();">แจ้งผลการพิจารณา Poster/Infographic</button>
                  @endif
