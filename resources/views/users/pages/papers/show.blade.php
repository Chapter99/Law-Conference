...
@section('title') รายละเอียดผลงาน @parent @endsection
  ...
  <div class="card">
    ...
    <div class="card-body">
        <table class="table table-hover">
            <tr>
                <th class="text-pt-blue" style="width: 23%">ชื่อเรื่อง</th>
        ...
        <div class="mt-3">
            <a class="btn btn-success" href="{{ route('users.home') }}">ย้อนกลับ</a>
        </div>
    </div>
    <!-- /.card-body -->
  </div>
