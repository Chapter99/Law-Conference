...
@section('title') การประเมินคุณภาพ Poster/Infographic @parent @endsection
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header bg-secondary">
            <h3 class="card-title">รายละเอียด Poster/Infographic</h3>
        ...
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><i class="far fa-file-image" aria-hidden="true"></i> <a
                            href="{{ asset('storage/poster/'.$paper->poster) }}" target="_blank">ไฟล์ภาพ</a>
                    </td>
                </tr>
            </table>
        </div>
  ...
  <div class="card">
    <div class="card-header bg-secondary">
      <h3 class="card-title">การประเมินคุณภาพ Poster/Infographic</h3>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('reviewerlogin.review_poster_save', $paper->id) }}" role="form" id="containerForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @if(old('s11') == 1) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s11 == 1) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s11') is-invalid @enderror" type="radio" name="s11" id="s112" value="2"
                        @if(old('s11') == 2) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s11 == 2) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s11') is-invalid @enderror" type="radio" name="s11" id="s113" value="3"
                        @if(old('s11') == 3) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s11 == 3) checked @endif>
                    </td>
                    <td><textarea class="form-control" id="c11" name="c11" rows="2">@if(old('c11') != ""){{ old('c11') }}@else{{ $paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->c11 }}@endif</textarea></td>
                </tr>
                <tr>
                    <td colspan="5">2. เนื้อหาประกอบการนำเสนอ</td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @if(old('s21') == 1) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s21 == 1) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s21') is-invalid @enderror" type="radio" name="s21" id="s212" value="2"
                        @if(old('s21') == 2) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s21 == 2) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s21') is-invalid @enderror" type="radio" name="s21" id="s213" value="3"
                        @if(old('s21') == 3) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s21 == 3) checked @endif>
                    </td>
                    <td><textarea class="form-control" id="c21" name="c21" rows="2">@if(old('c21') != ""){{ old('c21') }}@else{{ $paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->c21 }}@endif</textarea></td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @if(old('s22') == 1) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s22 == 1) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s22') is-invalid @enderror" type="radio" name="s22" id="s222" value="2"
                        @if(old('s22') == 2) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s22 == 2) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s22') is-invalid @enderror" type="radio" name="s22" id="s223" value="3"
                        @if(old('s22') == 3) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s22 == 3) checked @endif>
                    </td>
                    <td><textarea class="form-control" id="c22" name="c22" rows="2">@if(old('c22') != ""){{ old('c22') }}@else{{ $paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->c22 }}@endif</textarea></td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @if(old('s23') == 1) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s23 == 1) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s23') is-invalid @enderror" type="radio" name="s23" id="s232" value="2"
                        @if(old('s23') == 2) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s23 == 2) checked @endif>
                    </td>
                    <td class="text-center">
                        <input class="@error('s23') is-invalid @enderror" type="radio" name="s23" id="s233" value="3"
                        @if(old('s23') == 3) checked @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->s23 == 3) checked @endif>
                    </td>
                    <td><textarea class="form-control" id="c23" name="c23" rows="2">@if(old('c23') != ""){{ old('c23') }}@else{{ $paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->c23 }}@endif</textarea></td>
                </tr>
            </table>
            <p class="text-pt-blue font-weight-bold"><u>ข้อเสนอแนะอื่น ๆ </u></p>
            <textarea class="form-control" id="comment" name="comment" rows="3">@if(old('comment') != ""){{ old('comment') }}@else{{ $paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->comment }}@endif</textarea>
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <div class="form-check">
                            ...
                            @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->result == 1) checked @endif>
                    ...
                    <div class="form-check">
                            ...
                            @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->result == 2) checked @endif>
                    ...
                    <div class="form-check">
                            ...
                            @elseif($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->result == 3) checked @endif>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    @enderror
                    <span>
                        @if($paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->filename != NULL)
                        <a href="{{ asset('storage/review/'.$paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->filename) }}" target="_blank">ไฟล์แนบ</a>
                        @endif
                    </span>
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group row mt-2">
                @if (!$paper->reviewer_poster()->where('rev_id', Auth::guard('reviewer')->user()->id)->first()->pivot->approve)
